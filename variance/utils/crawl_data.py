...
import traceback
import logging
from os.path import (isdir, isfile, join, getsize, basename, normpath, dirname,
                     realpath)
...
from adblockparser import AdblockRules  # https://github.com/scrapinghub/adblockparser  # noqa
...
def process_crawl_pcaps(crawl_dir):
    ...
    multiproc(process_pcap, pcap_list)
